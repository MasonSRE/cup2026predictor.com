...
<footer class="footer"><p>Predictions are for information and entertainment only. They are not betting advice. Data updates are generated from the local model and source snapshots in this repository.</p><p><a href="/sitemap.xml">Sitemap</a> · <a href="https://github.com/MasonSRE/cup2026predictor.com">GitHub</a></p></footer>
</div>
