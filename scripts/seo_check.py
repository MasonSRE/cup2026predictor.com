...
required_pages = [
    ...
    'teams/spain/index.html','teams/brazil/index.html','teams/england/index.html','teams/usa/index.html',
    'teams/mexico/index.html','teams/france/index.html','teams/germany/index.html','teams/portugal/index.html',
    'teams/netherlands/index.html'
]
class MetaParser(HTMLParser):
    def __init__(self):
        super().__init__(); self.title=''; self._in_title=False; self._in_h1=False; self.h1=[]; self.canonical=None; self.description=None
...
if errors:
    ...
    sys.exit(1)
print('OK: checked', len(required_pages), 'pages and core assets')
